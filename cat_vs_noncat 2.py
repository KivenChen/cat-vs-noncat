...
def two_layer_model(X, Y, layers_dims, learning_rate = 0.0075, num_iterations = 3000, print_cost=False):
    ...
    for i in range(0, num_iterations):
        ...
        # Compute cost
        ### START CODE HERE ### (≈ 1 line of code)
        cost = compute_cost(A2, Y, parameters, lambd = 0.07)
        ### END CODE HERE ###
        ...
        ### START CODE HERE ### (≈ 2 lines of code)
        dA1, dW2, db2 = linear_activation_backward(dA2, cache2, activation="sigmoid", lambd = 0.07)
        dA0, dW1, db1 = linear_activation_backward(dA1, cache1, activation="relu", lambd = 0.07)
        ### END CODE HERE ###
...
def L_layer_model(X, Y, layers_dims, learning_rate = 0.0075, num_iterations = 3000, print_cost=False):#lr was 0.009
    ...
    for i in range(0, num_iterations):
        ...
        # Compute cost.
        ### START CODE HERE ### (≈ 1 line of code)
        cost = compute_cost(AL, Y, parameters, lambd = 0.07)
        ### END CODE HERE ###
    
        # Backward propagation.
        ### START CODE HERE ### (≈ 1 line of code)
        grads = L_model_backward(AL, Y, caches, lambd = 0.07)
        ### END CODE HERE ###
